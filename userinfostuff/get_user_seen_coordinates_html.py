...
def get_user_seen_coordinates(user_lat, user_lon, orientation):
    ...
    maxLat, minLat = -200, 200
    maxLon, minLon = -200, 200
...
def fovFlights(user_lat, user_lon, orientation, possibleFlights):
    ...
    # Ensure the "miscstuff" folder exists
    output_folder = "miscstuff"
    os.makedirs(output_folder, exist_ok=True)

    # Save the map to an HTML file inside "miscstuff"
    output_path = os.path.join(output_folder, "box_map.html")
